...
export default ({
  subheading = "",
  heading = "Reviews",
  description = "Here are some of the Reviews for our Services. Go through it to understand our quality of services towards your Hardware.",
  testimonials = [
    {
      customerName: "David Hanson",
      customerProfile: "Manager, Axis",
      // imageSrc:
